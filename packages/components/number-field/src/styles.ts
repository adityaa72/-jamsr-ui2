...
export const numberFieldVariants = tv({
  slots: {
    root: "number-field number-field__root flex flex-col gap-2",
    increment:
    ...
    input: "number-field__input outline-0 px-2 py-1",
    group: [
      "number-field__group w-max bg-background-secondary flex items-center rounded-md h-9",
