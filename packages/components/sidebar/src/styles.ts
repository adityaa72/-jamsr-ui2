...
export const sidebarVariants = tv({
  slots: {
    ...
    header: "py-2 px-4",
    content: "flex h-full flex-col gap-2 bg-surface",
    body: "p-2 grow flex flex-col gap-4 overflow-auto",
    group: "flex flex-col gap-1",
    groupLabel: "px-2 text-xs text-foreground-secondary",
    menu: "",
    menuItem: "",
    footer: "border-t border-divider py-2 px-4",
    menuItemButton: [
      "flex w-full items-center gap-1 rounded-md px-2 py-1.5 text-sm ui-hover:bg-surface-secondary",
